...
class RFID
{
  ...
  void init();
	...
	unsigned char serNum[4];       // Constante para guardar el numero de serie leido.
	unsigned char AserNum[4];      // Constante para guardar el numero d serie de la secion actual.
